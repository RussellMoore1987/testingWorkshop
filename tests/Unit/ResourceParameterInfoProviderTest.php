...
use App\Exceptions\ResourceParameterInfoProviderException;
use App\ResourceParameterInfoProvider;
use App\IntResourceParameterInfoProvider;
...
class ResourceParameterInfoProviderTest extends TestCase
{
    ...
    public function test_TestResourceParameterInfoProvider_throws_exception_when_required_attributes_are_not_set(string $classAttribute, int $code, $attributeValue): void
    {
        ...
        $this->expectExceptionMessage("The class attribute {$classAttribute} must be set in the child class \"Tests\Unit\TestResourceParameterInfoProvider\".");
    ...
    public static function attributeExceptionProvider(): array
    {
        return [
